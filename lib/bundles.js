...
export { MAX_BUNDLE_NAME, normalizeBundleName } from "./shared/bundleName.js";
 ...
 * which is what a transactionless driver can still make atomic. The no-op
 * DO UPDATE keeps a re-add returning a row, so "already a member" and "not
 * yours" stay distinguishable — with DO NOTHING they would both be empty.
 */
